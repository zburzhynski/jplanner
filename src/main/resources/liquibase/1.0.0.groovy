databaseChangeLog {
    ...
    changeSet(id: '2015-04-30-10', author: 'Vladimir Zburzhynski <zburzhynski@gmail.com>') {
        createTable(schemaName: 'jplanner', tableName: 'client', tablespace: 'jplanner_data', remarks: 'Client of clinic') {
            column(name: 'id', type: 'VARCHAR(128)', remarks: 'The unique identifier of client') {
                constraints(nullable: false)
            }
    ...
    changeSet(id: '2015-04-30-11', author: 'Vladimir Zburzhynski <zburzhynski@gmail.com>') {
        addForeignKeyConstraint(constraintName: 'FK_client_2_person',
                baseTableName: 'client', baseTableSchemaName: 'jplanner', baseColumnNames: 'person_id',
                referencedTableName: 'person', referencedTableSchemaName: 'jplanner', referencedColumnNames: 'id')
    }
    ...
    changeSet(id: '2015-04-30-14', author: 'Vladimir Zburzhynski <zburzhynski@gmail.com>') {
        addForeignKeyConstraint(constraintName: 'FK_schedule_2_client',
                baseTableName: 'schedule', baseTableSchemaName: 'jplanner', baseColumnNames: 'client_id',
                referencedTableName: 'client', referencedTableSchemaName: 'jplanner', referencedColumnNames: 'id')
    }
