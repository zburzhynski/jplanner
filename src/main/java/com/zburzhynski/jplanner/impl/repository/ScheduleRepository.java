...
import static com.zburzhynski.jplanner.impl.domain.Client.P_JDENT_PATIENT_ID;
import static com.zburzhynski.jplanner.impl.domain.Client.P_PERSON;
import static com.zburzhynski.jplanner.impl.domain.Person.P_ID;
import static com.zburzhynski.jplanner.impl.domain.Schedule.P_CLIENT;
...
public class ScheduleRepository extends AbstractBaseRepository<String, Schedule>
    ...
    public Schedule findById(String id) {
        ...
        criteria.createAlias(P_CLIENT + DOT + P_PERSON, P_PERSON);
    ...
    public List<Schedule> containByCriteria(ScheduleSearchCriteria containCriteria) {
        ...
        if (StringUtils.isNotBlank(containCriteria.getPatientId())) {
            criteria.createAlias(P_CLIENT, P_CLIENT);
            criteria.add(Restrictions.eq(P_CLIENT + DOT + P_JDENT_PATIENT_ID, containCriteria.getPatientId()));
        }
        return criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY).list();
    }
